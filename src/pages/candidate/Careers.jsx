      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100 mt-2">Discover your next career opportunity with us</p>
          </div>
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            ...
            <ul className="text-sm text-gray-700 space-y-1">
              ...
              <li>• Write a compelling cover letter highlighting your relevant experience</li>
              <li>• Our AI will automatically scan your resume for compatibility</li>
              <li>• Qualified candidates (60+ AI score) are forwarded to HR</li>
              <li>• Use the HR Assistant chat for personalized application guidance</li>
            </ul>
          </div>
        </div>
      </div>
